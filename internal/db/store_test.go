...
func TestOpenMigratesFreshDatabase(t *testing.T) {
	...
	for _, table := range []string{"settings", "provider_credentials", "client_api_keys", "catalog_refreshes", "models", "model_routes", "provider_health", "proxy_requests", "proxy_attempts", "request_usage", "routing_groups", "routing_group_stages", "routing_group_sources", "routing_group_stage_providers", "routing_group_stage_billing_classes", "sessions", "session_keys"} {
		var found string
