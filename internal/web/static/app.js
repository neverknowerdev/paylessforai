(() => {
  ...
  const modelDiscountDetail = (model) => model.discount_percent_bps == null ? 'no official baseline' : `input ${discountPercent(model.discount_input_percent_bps)} · output ${discountPercent(model.discount_output_percent_bps)} vs official`;
