(() => {
  const state = { requests: [], models: [], modelStats: [], providerStats: [], groupStats: [], groups: [], summary: {}, view: 'overview', detailDrawer: null, modelSort: { key: null, direction: null }, modelFilters: { model: [], provider: [], tags: [], input: [], output: [] }, filterPopover: null };
  ...
  updateProviderFormMode(); setText('#base-url', `${window.location.origin}/v1`); Promise.all([loadStatus(), loadSummary(), loadRequests(), loadModelStats(), loadProviderStats(), loadGroupStats(), loadModels(), loadKeys(), loadProviders(), loadGroups()]);
