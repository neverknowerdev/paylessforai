(() => {
  ...
  async function loadStatus() {
    try {
      ...
      setText('#status', data.ready ? 'Ready' : 'Starting · database not ready');
  ...
  setInterval(() => { if (!document.hidden) loadModels(); }, 60_000);
