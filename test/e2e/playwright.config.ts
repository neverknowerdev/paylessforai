...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: 'go run ../../cmd/paylessforai-server -data-dir /tmp/paylessforai-e2e -listen 127.0.0.1:19477 -openrouter-base-url http://127.0.0.1:19475/openrouter/api/v1 -surplus-base-url http://127.0.0.1:19476/surplus/v1', url: appURL + '/readyz', reuseExistingServer: true, timeout: 120_000 },
  ],
});
